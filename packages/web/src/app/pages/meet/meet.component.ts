...
import {AuthData, AuthenticationService, IUserGooglePermissions} from "../../services/auth.service";
...
export class MeetComponent{
    ...
    createMeeting() {
        this.meeting$ = this.dataService.getObservableData('/google-calendar/create-google-meeting');
    }
