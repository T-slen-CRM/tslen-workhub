  ...
  loadTranslations() {
    this.translateService
      ...
      .subscribe((transation) => {
        this.columnDefs = [
          {
            headerName: transation['pending.data.firs_name'],
            field: 'firstName',
          },
          {
            headerName: transation['pending.data.last_name'],
            field: 'lastName',
            pinned: 'left',
          },
          // {headerName: 'Title', field: 'title', minWidth: 90},
          {
            headerName: transation['pending.data.type'],
            field: 'type',
            minWidth: 90,
          },
          {
            headerName: transation['pending.data.start'],
            field: 'start',
            minWidth: 160,
            cellRenderer: 'pendingDateRendererComponent',
          },
          {
            headerName: transation['pending.data.end'],
            field: 'end',
            minWidth: 160,
            cellRenderer: 'pendingDateRendererComponent',
          },
          {
            headerName: transation['pending.data.created'],
            field: 'createdAt',
            minWidth: 90,
            cellRenderer: 'pendingDateRendererComponent',
          },
          {
            headerName: transation['pending.data.actions'],
            field: 'actions',
            minWidth: 120,
            cellRenderer: 'pendingActionsRendererComponent',
          },
        ];
      });
  }
