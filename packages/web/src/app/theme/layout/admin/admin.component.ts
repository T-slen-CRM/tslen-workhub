...
export class AdminComponent implements OnInit {
  ...
  public activeCallData: Signal<{callerId: number, calleeId: number}> = this.liveChatService.getActiveCallData();
...
handleIncomingCall(data: { callerId: string; callerName: string; calleeId: string, img: string, callerLastName: string; }) {
