...
@Component({
    ...
    imports: [CommonModule, MatButtonModule, MatInputModule, FormsModule, MatPanelDynamicComponent, PanelDirective, NgOptimizedImage, MatCheckboxModule, MatListModule, ReactiveFormsModule, TranslateModule],
    templateUrl: './google-calendar.component.html',
    styleUrls: ['./google-calendar.component.scss']
})
export class GoogleCalendarComponent extends UnsubscribeOnDestroyAdapter implements OnInit{
  ...
  ngOnInit() {
    ...
    const calendarData: Subscription = this.googleCalendarData$.subscribe((data: IGoogleCalendarData) => {
  ...
  googleAuth() {
      const postData: Subscription = this.dataService.getObservableData('/google-calendar/authorize')
  ...
  resetAuth() {
    ...
    const postData: Subscription = this.dataService.deleteData('/google-calendar/', calendarData.id)
