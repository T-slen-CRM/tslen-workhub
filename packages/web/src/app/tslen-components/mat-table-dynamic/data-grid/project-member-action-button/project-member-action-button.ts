...
export class ProjectMemberActionButton extends UnsubscribeOnDestroyAdapter implements AfterViewInit{
 ...
 public inputRow: IProjectPermission;
  ...
  constructor(private dataService: DataService,
    ...
    onDelete() {
        this.loading = true;
        if (this.inputRow?.id){
            this.matTableService.setChangedMembersRow({action: 'delete', row: this.inputRow});
