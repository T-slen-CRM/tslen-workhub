  ...
  public columnDefs: ColDef[] = [];
    ...
    loadTranslations(): void {
      this.translateService.get([
          ...
          this.columnDefs = [
            {headerName: transation['people.days_off.data.title'], field: 'title', sortable: true, filter: true, resizable: true, width: 282,
                valueFormatter: (param) => this.staticDaysOffObject[param.value] ? this.staticDaysOffObject[param.value].title : param.value},
            {headerName: transation['people.days_off.data.status'], field: 'approved', sortable: true, filter: true, resizable: true, width: 282,
                cellRenderer: (params) => this.statusFormatter(params)},
            {headerName: transation['people.days_off.data.start'], field: 'start', sortable: true, filter: true, resizable: true, width: 282,
                valueFormatter: (param) => this.dateFormatter(param)},
            {headerName: transation['people.days_off.data.end'], field: 'end', sortable: true, filter: true, resizable: true, width: 282,
                valueFormatter: (param) => this.dateFormatter(param)},
            {headerName: transation['people.days_off.data.comment'], field: 'comment', sortable: true, filter: true, resizable: true, width: 282},
          ]
        })
    }
