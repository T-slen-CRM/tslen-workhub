...
@Component({
    ...
    imports: [
        CommonModule, MatIconModule, MatChipsModule,
        MatSelectModule, MatButtonModule, MatTooltipModule
    ],
...
export class ImageSelectionComponent implements ControlValueAccessor, Validator {
  public logoArr: any;
  ...
  constructor(private libsService: LibsService,
    ...
    this.logoObject = {
      not_interested: {icon: 'not_interested', color: '#000', title: 'No image'},
